...
//   // 🎤 When speech input is done
//   const handleSpeechResult = (text) => {
//     setQuery(text);
//   };

//   // 🤖 When ChatBot returns answer
//   const handleAnswer = (res) => {
//     const english = typeof res === "string" ? res : res.english;
//     const tamil = typeof res === "object" && res.tamil;
...
//   // 🎙️ Voice Command Switcher
//   const handleVoiceCommand = (command) => {
//     const normalized = command.toLowerCase();
//     console.log("🎙️ Voice command received:", command);

//     if (normalized.includes("chatbot") || normalized.includes("gemini")) {
//       setActiveTab("qna");
//       speak("Feature switched to chatbot");
...
//           🤖 Q&A Chatbot
//         </button>
//         <button className={activeTab === "hospital" ? "active" : ""} onClick={() => setActiveTab("hospital")}>
//           🏥 Hospital Q&A
//         </button>
//         <button className={activeTab === "reminder" ? "active" : ""} onClick={() => setActiveTab("reminder")}>
//           📅 Set Reminder
//         </button>
//         <button className={activeTab === "voiceReminder" ? "active" : ""} onClick={() => setActiveTab("voiceReminder")}>
//           🎙️ Voice Reminder
//         </button>
//         <button className={activeTab === "college" ? "active" : ""} onClick={() => setActiveTab("college")}>
//           🎓 College Q&A
//         </button>
//       </nav>
...
//       <TextToSpeech text={answer} lang={lang} />
//     </div>
